...
module EvilCTF
  module Tools
    ...
    def self.disable_defender(shell)
      ...
      puts '[!] Tamper Protection Enabled, will try anyways' if tamper_check.output.include?('True')
      ...
      final_status = EvilCTF::Execution.run(shell,
                                            'Get-MpComputerStatus | Select-Object -ExpandProperty RealTimeProtectionEnabled', timeout: 10)
